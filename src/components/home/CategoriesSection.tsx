...
export const CATEGORY_DATA: Category[] = [
  {
    ...
    shortLabel: 'Property',
    description: 'Verify land documents, confirm ownership, and inspect physical properties before any transaction.',
    priceFrom: '₦5,000',
  ...
  },
  {
    ...
    shortLabel: 'Products',
    description: 'Authenticate goods, confirm physical condition, and verify listings match reality before you pay.',
    priceFrom: '₦2,000',
  ...
  },
  {
    ...
    label: 'Vehicles',
    shortLabel: 'Vehicles',
    description: 'Comprehensive inspection — engine, chassis, papers, and full body condition before you buy.',
    priceFrom: '₦5,000',
  ...
  },
  {
    ...
    description: 'Verify academic certificates, legal papers, and official documents for authenticity and legitimacy.',
    priceFrom: '₦3,000',
    turnaround: '24–72 hrs',
    icon: 'document',
  ...
  },
  {
    ...
    shortLabel: 'Identity',
    description: 'NIN verification, background checks, and identity confirmation — know exactly who you are dealing with.',
    priceFrom: '₦5,000',
  ...
  },
  {
    ...
    description: 'Verify seller legitimacy, confirm physical store locations, and check inventory before sending payment.',
    priceFrom: '₦3,000',
    turnaround: '12–48 hrs',
    icon: 'store',
  ...
  },
  {
    ...
    shortLabel: 'Services',
    description: 'Verify contractors, artisans, and service providers before you hire and before you make any payment.',
    priceFrom: '₦5,000',
    turnaround: '24–72 hrs',
    icon: 'service',
  ...
  },
  {
    ...
    label: 'Luxury Items',
    shortLabel: 'Luxury',
    description: 'Authenticate designer goods, luxury watches, jewellery, and high-value collectibles with expert eyes.',
    priceFrom: '₦10,000',
    turnaround: '48–96 hrs',
    icon: 'luxury',
  ...
  const map: Record<string, ReactElement> = {
    property: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <path d="M3 10.5L12 3l9 7.5V21H3V10.5z" stroke={stroke} strokeWidth={sw} strokeLinejoin="round" />
        <path d="M9 21V14h6v7" stroke={stroke} strokeWidth={sw} />
      </svg>
    ),
    product: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <rect x="3" y="3" width="7.5" height="7.5" rx="1.5" stroke={stroke} strokeWidth={sw} />
        <rect x="13.5" y="3" width="7.5" height="7.5" rx="1.5" stroke={stroke} strokeWidth={sw} />
        <rect x="3" y="13.5" width="7.5" height="7.5" rx="1.5" stroke={stroke} strokeWidth={sw} />
        <rect x="13.5" y="13.5" width="7.5" height="7.5" rx="1.5" stroke={stroke} strokeWidth={sw} />
      </svg>
    ),
    vehicle: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <path d="M5 10.5l2.5-5.5h9l2.5 5.5" stroke={stroke} strokeWidth={sw} strokeLinecap="round" />
        <rect x="2" y="10.5" width="20" height="7" rx="2" stroke={stroke} strokeWidth={sw} />
    ...
    document: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <path d="M14 3H6a1 1 0 00-1 1v16a1 1 0 001 1h12a1 1 0 001-1V8l-5-5z" stroke={stroke} strokeWidth={sw} strokeLinejoin="round" />
        <path d="M14 3v5h5M8 13h8M8 17h5" stroke={stroke} strokeWidth={sw} strokeLinecap="round" />
      </svg>
    ),
    identity: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        ...
        <path d="M13 10h6M13 14h4" stroke={stroke} strokeWidth={sw} strokeLinecap="round" />
      </svg>
    ),
    store: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <path d="M3 3h18l-2 7H5L3 3z" stroke={stroke} strokeWidth={sw} strokeLinejoin="round" />
    ...
    service: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        ...
        <path d="M4 20c0-3.314 3.582-6 8-6s8 2.686 8 6" stroke={stroke} strokeWidth={sw} strokeLinecap="round" />
      </svg>
    ),
    luxury: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <path d="M12 2.5l2.5 7.5H22l-6.5 4.7 2.5 7.5L12 17.5l-6 4.7 2.5-7.5L2 10h7.5L12 2.5z" stroke={stroke} strokeWidth={sw} strokeLinejoin="round" />
      </svg>
    ),
  }
...
function CategoryCard({ cat, index, size = 'normal', animationDelay = 0 }: CardProps) {
      ...
      >
        ...
        <div
          style={{
            ...
            height: 2,
            background: 'linear-gradient(to right, #1d4ed8, #3b82f6, transparent)',
            opacity: hovered ? 1 : 0,
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 14 }}>
            <div
              style={{
                ...
                height: 42,
                borderRadius: '50%',
                background: hovered ? 'rgba(29,78,216,0.28)' : 'rgba(29,78,216,0.18)',
          ...
          >
            ...
            >
              ...
              <svg
                ...
                style={{ transform: hovered ? 'translateX(3px)' : 'translateX(0)', transition: 'transform 250ms' }}
              >
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      {groups.map((g, i) => {
        ...
        const tallCard = <CategoryCard cat={g.tall} index={i * 3} size="tall" animationDelay={i * 0.06} />
        const stackCards = (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, height: '100%' }}>
            <CategoryCard cat={g.a} index={i * 3 + 1} size="normal" animationDelay={i * 0.06 + 0.09} />
...
export default function CategoriesSection({
  ...
  return (
    <section
      style={{
        background: gridMode ? 'var(--bg-secondary, #f8f9fa)' : 'var(--bg, #fff)',
          ...
          >
            <div>
              ...
              <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 14, color: 'rgba(255,255,255,0.6)' }}>
                Describe what you want checked and we will guide you to the right one.
              </p>
            </div>
            <Link
              href={BRAND.appUrl}
            ...
            >
              ...
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M2.5 7h9M7.5 3l4 4-4 4" stroke="#1d4ed8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </Link>
          </motion.div>
        </div>
